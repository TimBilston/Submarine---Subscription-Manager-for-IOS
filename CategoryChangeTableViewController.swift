//
//  CategoryChangeTableViewController.swift
//  Submarine
//
...
import UIKit
protocol sendCategoryProtocol {
    func sendCategory(category: SubscriptionCategory)
}
class CategoryChangeTableViewController: UITableViewController, DatabaseListener {
    ...
    var delegate: sendCategoryProtocol? = nil
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        self.delegate?.sendCategory(category: categoryList[indexPath.row])
